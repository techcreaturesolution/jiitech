  ...
  return (
    <div>
      {isOpenMenu && (
        <div className="sm:hidden fixed z-20 inset-0 bg-red-800">
          ...
          <div className="flex flex-col pt-8 text-white text-3xl font-[20px]  text-center gap-4 ">
            ...
            <p>
              <Link to={"/gallery"}>STUDENT EXPERIENCE </Link>
            </p>
      ...
      <div
        className={
          navbar
            ? "bg-white duration-300 fixed top-0 flex w-full z-50 items-center py-2 shadow-md"
            : "duration-300 fixed top-0 flex w-full z-50 items-center py-2 shadow-md"
        }
      >
